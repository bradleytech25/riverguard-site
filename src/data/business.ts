 ...
 *
 * Values in [SQUARE BRACKETS] are placeholders Brad still needs to fill in.
...
export const business = {
  ...
  // TODO(Brad): confirm contact details
  phone: '[PHONE NUMBER]',
  email: '[EMAIL ADDRESS]',
  hours: '[HOURS — e.g. Monday–Friday, 8am–5pm Mountain]',
  address: {
  ...
  stats: [
    ...
    // TODO(Brad): real measured figures
    { value: '[12] min', label: 'average response time' },
    { value: '[40]+', label: 'local businesses supported' },
  ],

  // TODO(Brad): list the certifications you hold (e.g. CompTIA Security+, Microsoft 365 Certified)
  ...
  // TODO(Brad): links, or leave empty to hide
  social: {
    googleBusiness: '',
    linkedin: '',
  },
